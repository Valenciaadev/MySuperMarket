<?php 
$seccion_actual = 'Existencias';
$seccion_nombre = 'EXISTENCIAS';
include('../PanelControl/headerView.php'); ?>
    ...
    <div class="flex-1 flex flex-col mx-4">
        ...
        <div class="ml-8 mt-8">
            <h1 class="text-4xl font-semibold">EXISTENCIAS</h1>
            <p class="text-lg text-gray-700 mt-1 mb-12">8 Productos</p>
        </div>
        ...
        <div class="flex flex-1 justify-center items-start">
            <div class="bg-white shadow-lg rounded-lg p-4 w-full max-w-5xl" style="background-color: #FFFFFD;">
                ...
                <div class="flex justify-between items-center mt-6 mb-4 w-full">
                    <button id="add-limpieza-btn" class="text-white px-4 py-2 rounded-full shadow-lg" style="background-color: #2A5A19;">
                        + AGREGAR PRODUCTO
                    </button>        
                    
                    <div>
                        <input type="text" placeholder="Buscar Producto" class="px-4 py-2 rounded-full shadow-lg">
                    </div>
                </div>
                ...
                <table class="table-auto w-full border-separate" style="border-spacing: 0px 12px;">
                    ...
                    <thead class="bg-white rounded-full"  style="  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.1); background-color: #F2F2EA;">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-left">UNIDADES DISPONIBLES</th>
                    ...
                    <tbody id="table-body" class="bg-gray-100">
                        ...
                        <tr class="table-row bg-sky-100 mb-2 overflow-hidden " style="border-radius: 50px;  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.1); background-color: #F2F2EA;">
                            <td class="px-4 py-3 text-left" style="border-top-left-radius: 50px; border-bottom-left-radius: 50px;">Carlos Manuel Eusebio Alejo</td>
                            <td class="px-4 py-3 text-left">INETEC</td>
                            <td class="px-4 py-3 text-left">Electrodomesticos</td>
                            <td class="px-4 py-3 text-left">$3,500</td>
                            <td class="px-4 py-3 text-left">100</td>
...
<div id="edit-limpieza-modal" class="fixed inset-0 flex items-center justify-center bg-opacity-50 bg-black hidden">
    <div class="p-8 rounded-lg overflow-auto relative" style="background-color: #FBFDFF; height: 530px; width: 600px;">
       <!-- Botón X para cerrar el modal -->
      <button id="close-edit-limpieza-modal-x" class="absolute top-0 right-0 m-2 pb-px border-4 border-green-700 text-white hover:text-white w-8 h-8 rounded-full flex items-center justify-center text-lg font-bold" style="background-color: #2A5A19;">&times;</button>
      ...
      <div class="p-6 rounded-sm shadow-md mb-10" style="background-color: #f5f7ff;">
        <div class="grid grid-cols-2 gap-6">
          ...
          <div class="relative col-span-2">
            <label class="text-xs text-[#3B3636]">NOMBRE DEL PRODUCTO</label>
          ...
          <div class="relative col-span-2">
            <label class="text-xs text-[#3B3636]">PRECIO UNITARIO</label>
            <input class="pl-8 py-2 text-xs bg-[#E6ECF8] rounded-full w-full shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636]" type="number" placeholder="Precio">
          </div>

           <!-- Select: Género -->
          <select class="pl-8 py-2 bg-[#E6ECF8] col-span-2 text-xs rounded-full w-full shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636]" id="gender">
              <option disabled selected>CATEGORIA</option>
              <option value="femenino">ELECTRODOMESTICOS</option>
              <option value="masculino">LIMPIEZA</option>
          </select>
...
<div id="limpieza-modal" class="fixed inset-0 flex items-center justify-center bg-opacity-50 bg-black hidden">
    <div class="p-8 rounded-lg overflow-auto relative" style="background-color: #FBFDFF; height: 540px; width: 600px;">
      <!-- Botón X para cerrar el modal -->
      <button id="close-limpieza-modal-x" class="absolute top-0 right-0 m-2 pb-px border-4 border-green-700 text-white hover:text-white w-8 h-8 rounded-full flex items-center justify-center text-lg font-bold" style="background-color: #2A5A19;">&times;</button>
      ...
      <div class="flex justify-end mt-6">
        <!-- Botón de cerrar -->
        <button id="close-limpieza-modal-btn" class="text-white px-4 py-2 rounded-full mr-2 shadow-inner" style="background-color: #2A5A19;">
          Cerrar
        </button>
        <button id="submit-limpieza" class="text-white px-4 py-2 rounded-full shadow-md" style="background-color: #2A5A19;">
          Guardar
        </button>
      </div>
    </div>
