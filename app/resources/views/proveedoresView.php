...
include('../PanelControl/headerView.php'); ?>
    ...
    <div class="flex-1 flex flex-col mx-4">
        ...
        <div class="ml-8 mt-8">
            <h1 class="text-4xl font-semibold">Proveedores</h1>
            <p class="text-lg text-gray-700 mt-1 mb-12">8 Proveedores</p>
        </div>
        ...
        <div class="flex flex-1 justify-center items-start">
            <div class="bg-white shadow-lg rounded-lg p-4 w-full max-w-5xl" style="background-color: #FFFFFD;">
                ...
                <div class="flex justify-between items-center mt-6 mb-4 w-full">
                    ...
                    <div>
                        <input type="text" placeholder="Buscar Provedor" class="px-4 py-2 rounded-full shadow-lg">
                    </div>
                </div>
                ...
                <table class="table-auto w-full border-separate" style="border-spacing: 0px 12px;">
                    ...
                    <thead class="bg-white rounded-full"  style="  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.1); background-color: #F2F2EA;">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-left">PERSONA DE CONTACTO</th>
      ...
      <div class="p-6 rounded-sm shadow-md mb-10" style="background-color: #f5f7ff;">
        <div class="grid grid-cols-2 gap-6">
          ...
          <div class="relative col-span-2">
            <label class="text-xs text-[#3B3636]">NOMBRE COMPLETO</label>
            <input class="pl-8 py-2 text-xs bg-[#E6ECF8] rounded-full w-full shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636]" type="text" placeholder="Nombre Completo">
          </div>
  
          <!-- Input: Número de Teléfono -->
          <div class="relative col-span-2">
            <label class="text-xs text-[#3B3636]">EMPRESA</label>
            <input class="pl-8 py-2 text-xs bg-[#E6ECF8] rounded-full w-full shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636]" type="text" placeholder="Nombre de la Empresa">
          </div>
          ...
          <select class="pl-8 py-2 bg-[#E6ECF8] col-span-2 text-xs rounded-full w-full shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-[#3B3636]" id="gender">
              ...
              <option value="femenino">ADMINISTRADOR</option>
              <option value="masculino">TRABAJADOR</option>
          </select>
