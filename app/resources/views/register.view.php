        ...
        <div class="card-body">
            ...
            <form action="" id="register-form">
                <div class="form-group input-group mb-3">
                    <label for="name" class="input-group-text"><i class="bi bi-person-vcard"></i></label>
                ...
                <div class="form-group input-group mb-3">
                    <label for="passwd2" class="input-group-text"><i class="bi bi-lock-fill"></i></label>
                    <input type="password" class="form-control"
                            id="passwd2"
                            name="passwd2"
                ...
                <div class="d-grid gap-2 my-2">
                    ...
                    <a href="/Session/iniSession" class="btn btn-link float-end">Ya tengo una cuenta</a>
                </div>
            </form>
        </div>
    </div>
