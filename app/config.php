...
define('PORT', IS_LOCAL ? '8000' : 'REMOTE PORT');
define('URL', IS_LOCAL ? 'localhost:' . PORT . DS : 'REMOTE URL');

define('DB_HOST', IS_LOCAL ? 'localhost' : 'REMOTE HOST');
define('DB_USER', IS_LOCAL ? 'root' : 'REMOTE USER');
define('DB_PASS', IS_LOCAL ? 'manuel123' : 'REMOTE PASSWORD');
define('DB_NAME', IS_LOCAL ? 'mysupermarket' : 'REMOTE DATABASE NAME');
