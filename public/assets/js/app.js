                 ...
                 `<div class="my-3 pb-3 border-bottom" style="overflow:hidden;">
                  ...
                  <span id="comentarios" class="float-end fw-bolder">
                    <small>
                        <a href="#" class="btn btn-link btn-sm text-decoration-none 
                            ${ post[2].tt > 0 ? '' : 'disabled'} link-secondary"
                  ...
                  <div class="input-group mb-3">
                    <input type="text" name="comment" id="comment"
                            ...
                            placeholder="${ !app.user.sv ? 'Regístrate o inicia sesión para poder hacer comentarios' : 'Deja un comentario' }">
                    <button class="btn btn-outline-primary rounded-5 border border-light"
                            type="button" id="btn-comment-send"
                            ${ !app.user.sv ? 'disabled' : '' } onclick="app.saveComment(event,${ post[0].id },${ app.user.id })">
